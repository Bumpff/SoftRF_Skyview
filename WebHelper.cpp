...
<tr>\
<th align=left>Screen layout</th>\
<td align=right>\
<select name='portland'>\
<option %s value='%d'>Portrait</option>\ 
<option %s value='%d'>Landscape</option>\
</select>\
</td>\
</tr>\
<tr>\
...
<tr>\
<th align=left>Nav Waypoint</th>\
<td align=right>\
<select name='waypoint'>\
<option %s value='%d'>YBEV</option>\ 
<option %s value='%d'>YCUN</option>\ 
<option %s value='%d'>YNRG</option>\
</select>\
</td>\
</tr>\
<tr>\
...
<option %s value='%d'>make & model</option>\
  ...
  (settings->portland == SCREEN_PORTRAIT    ? "selected" : ""), SCREEN_PORTRAIT,
  (settings->portland == SCREEN_LANDSCAPE    ? "selected" : ""), SCREEN_LANDSCAPE,
  (settings->vmode == VIEW_MODE_RADAR ? "selected" : ""), VIEW_MODE_RADAR,
  (settings->vmode == VIEW_MODE_NAV ? "selected" : ""), VIEW_MODE_NAV,
  ...
  (settings->waypoint == YBEV  ? "selected" : ""), YBEV,
  (settings->waypoint == YCUN  ? "selected" : ""), YCUN,
  (settings->waypoint == YNRG  ? "selected" : ""), YNRG,
...
<select name='voice'>\
<option %s value='%d'>Off</option>\
<option %s value='%d'>Voice</option>\
<option %s value='%d'>Buzzer</option>\
</select>\
</td>\
</tr>"),
...
//<option %s value='%d'>voice 3</option>
    ...
    (settings->voice == VOICE_BUZZER ? "selected" : ""), VOICE_BUZZER
...
void handleInput() {
  ...
  for ( uint8_t i = 0; i < server.args(); i++ ) {
    ...
    } else if (server.argName(i).equals("portland")) {
      settings->portland = server.arg(i).toInt();

    } else if (server.argName(i).equals("waypoint")) {
      settings->waypoint = server.arg(i).toInt();
...
<tr><th align=left>Screen layout</th><td align=right>%d</td></tr>\
...
<tr><th align=left>Nav waypoint</th><td align=right>%d</td></tr>\
...
<hr>\
  ...
  settings->units, settings->portland, settings->vmode, settings->orientation, settings->zoom,
  settings->waypoint,settings->adb, settings->idpref, settings->voice, settings->aghost,
